...
namespace TrackCell.Api.Services
{
    public class OperationHistoryService
    {
        ...
        public async Task LogActionAsync(string badgeNumber, string partNumber, string serialNumber, string opNumber, string actionLevel, int goodQty = 0, int scrapQty = 0, string? scrapCode = null)
        {
