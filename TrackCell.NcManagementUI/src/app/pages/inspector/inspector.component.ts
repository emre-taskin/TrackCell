...
import { NonConformance, OperationDefinition, PartDefinition, PartImage, PartSerial } from '../../models/nc.models';
...
export class InspectorComponent {
  ...
  submitInspection(): void {
    this.toast.show('Inspection submitted successfully (Demo)', 'success');
    this.reset();
  }
